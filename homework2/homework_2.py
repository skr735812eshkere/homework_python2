...
# набор правил, которые позволяют осущесталять бинарные операции с массивами разных форм и размеров
# a = np.array([0,1,2])
# b = np.array([5,5,5])
#
# print(a + b)
...
# 2. Если формы массивов не совпадают в каком-то измерении, то если  у массива форма равна 1, то он "растягивается" до формы второго массива
...
# c = a + b
# print(c)
# # Что надо изменить в последнем примере, чтобы он работал без ошибок
# a = np.ones((3,2))
